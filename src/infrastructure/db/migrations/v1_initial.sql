-- src/infrastructure/db/migrations/v1_initial.sql
-- Este archivo es la fuente de verdad del DDL de v1.
-- El DatabaseMigrationRunner lo ejecuta al arrancar si schema_version = 0.
...
-- Índices críticos de rendimiento (AC-1 — los 5 son obligatorios)
